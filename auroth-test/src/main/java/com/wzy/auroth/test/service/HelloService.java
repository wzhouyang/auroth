...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-07-26")
public class HelloService {

  public interface Iface {

    public com.wzy.auroth.test.consul.register.po.User getUser(long id) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public com.wzy.auroth.test.consul.register.po.User recv_getUser() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getUser_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public com.wzy.auroth.test.consul.register.po.User getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getUser<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getUser_args, com.wzy.auroth.test.consul.register.po.User> {
      public getUser() {
        super("getUser");
      }
      ...
      public AsyncMethodCallback<com.wzy.auroth.test.consul.register.po.User> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<com.wzy.auroth.test.consul.register.po.User>() { 
          public void onComplete(com.wzy.auroth.test.consul.register.po.User o) {
            getUser_result result = new getUser_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getUser_args args, org.apache.thrift.async.AsyncMethodCallback<com.wzy.auroth.test.consul.register.po.User> resultHandler) throws TException {
  ...
  public static class getUser_result implements org.apache.thrift.TBase<getUser_result, getUser_result._Fields>, java.io.Serializable, Cloneable, Comparable<getUser_result>   {
    ...
    public com.wzy.auroth.test.consul.register.po.User success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.wzy.auroth.test.consul.register.po.User.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getUser_result(
      com.wzy.auroth.test.consul.register.po.User success)
    {
      this();
    ...
    public getUser_result(getUser_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.wzy.auroth.test.consul.register.po.User(other.success);
      }
    }
    ...
    public com.wzy.auroth.test.consul.register.po.User getSuccess() {
      return this.success;
    }

    public getUser_result setSuccess(com.wzy.auroth.test.consul.register.po.User success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((com.wzy.auroth.test.consul.register.po.User)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new com.wzy.auroth.test.consul.register.po.User();
